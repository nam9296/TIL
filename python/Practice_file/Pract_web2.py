...
print(One_number('1038495067'))


'''
2. emails = ['python@mail.example.com', 'python+kr@example.com',              # 올바른 형식
...
import re
print(re.search("\w+[.+-_]?\w+[@]\w+[.+-_]?\w+[.]\w+","python.dojang@e-xample.com"))
...
res=re.split("\\[캐스터]",new)
print(res[1])


# 2)달린 댓글의 개수를 출력하시오
print(re.search("댓글\d",new)[0])

# 3)대전의 온도를 출력하시오
print(re.search('대전 \d+도',new)[0])
